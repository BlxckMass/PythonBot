package ru.blackmass.bot.commands.tasks;
...
public class TasksCommand extends VkCommand {
    ...
    @Autowired
    public TasksCommand(VkApiClient vk, GroupActor group, Logger log, PythonKeyboard pythonKeyboard) {
        super(vk, group, log);
        this.log = log;
    ...
    public void run(Message message) {
        sendMessage(MessageTextUtil.getTasksText(), message, pythonKeyboard.createTaskKeyboard());
    }
}
