...
@Component
public class TopClickersCommand extends VkCommand {
    ...
    @Autowired
    public TopClickersCommand(VkApiClient vk, GroupActor group, Logger log, UserService userService, PythonKeyboard pythonKeyboard) {
        super(vk, group, log);
        this.log = log;
    ...
    public void run(Message message) {
        ...
        int numberToper = 1;
        List<User> topUsers = userService.findUsersByTopCountClick();
