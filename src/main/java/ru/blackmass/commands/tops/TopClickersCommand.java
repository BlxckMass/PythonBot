...
public class TopClickersCommand extends VkCommand {
    ...
    @Autowired
    public TopClickersCommand(VkApiClient vk, GroupActor group, UserService userService, PythonKeyboard pythonKeyboard) {
        super(vk, group);
    ...
    public void run(Message message) throws ClientException, ApiException {
        ...
        int numberToper = 1;
        List<User> topUsers = userService.getUsersTopCountClick();
